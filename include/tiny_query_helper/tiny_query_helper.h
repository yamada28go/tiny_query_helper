...
#error "This code was setted for table tuple 5."
    ...
    template<typename T1, typename T2 = mpl_::void_, typename T3 = mpl_::void_,
    typename T4 = mpl_::void_, typename T5 = mpl_::void_>
  ...
  private:
    ...
    {
      query_object< TABLE_TYPE_ >::group_by_.term_.push_back (First::name_);
    }
