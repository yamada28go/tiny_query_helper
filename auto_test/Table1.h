	  	...
	  	struct data2_string : public tiny_query_helper::column_type::wrap_string< Table1 >
    {
	  ...
	  struct data{
            ...
            //! tiny query helperが必要なテーブル情報一覧を作成する
            	            	const static ::hoge::Table1::column::type::id id;
            	            	const static ::hoge::Table1::column::type::data1_int data1_int;
            	            	const static ::hoge::Table1::column::type::data2_string data2_string;
